...
- Managing conversational state across multiple user turns.
- Preventing repeated questions in slot-filling workflows.
- Handling intent switching without breaking the booking flow.
- Secure email configuration using Gmail App Passwords.
- Designing a clean, maintainable architecture within a single Streamlit application.

---

## 9. Future Improvements

- Authentication and role-based access for admin users.
- Real-time calendar integration for slot availability.
- Speech-to-text and text-to-speech support.
- Booking modification and cancellation flows.
- Persistent production database (PostgreSQL / Supabase).
- Improved UI and analytics for admin insights.
...
It demonstrates not just AI usage, but the ability to design and deploy a **complete, production-style AI application**.
